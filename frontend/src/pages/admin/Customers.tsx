    ...
    <AdminLayout title="Khách hàng">
      <div className="space-y-4">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-gray-400">Chức năng quản lý khách hàng đang phát triển.</p>
          <p className="text-xs text-gray-600">API endpoint: GET /api/admin/customers</p>
        </div>
      </div>
    </AdminLayout>
  );
